...
public class TestXinhuaWebService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 这个MD5的包找不到
        //String md5 = MD5.encrypt(temp).toLowerCase();
        //String md5 = Hashing.md5().newHasher().putString(temp, Charsets.UTF_8).hash().toString();
        String md5 = Hashing.md5().hashString(temp, Charset.forName("UTF-8")).toString();
        String par_value = "";

        byte[] data = (byte[]) (call.invoke(new Object[]{"productInfo01", khid, md5, "xml", par_value}));
